...
public static class ItemAffixUtility
{
    ...
    private static AffixPool CreateRuntimeDefaultPool()
    {
        ...
        var definitions = new List<AffixDefinition>
        {
            ...
            CreateRuntimeDefinition(AffixType.Accuracy, AffixCategory.Offensive, AffixItemTarget.Weapon, 0.1f, 0.3f, AffixValueKind.Percent, groupId: "weapon_precision"),
            CreateRuntimeDefinition(AffixType.EffectiveRange, AffixCategory.Offensive, AffixItemTarget.Weapon, 0.1f, 0.3f, AffixValueKind.Percent, groupId: "weapon_precision"),
            ...
            CreateRuntimeDefinition(AffixType.ArmorBonus, AffixCategory.Defensive, AffixItemTarget.Armor, 10f, 50f, AffixValueKind.Flat, weight: 1f, groupId: "armor_class"),
            CreateRuntimeDefinition(AffixType.ArmorLevel, AffixCategory.Defensive, AffixItemTarget.Armor, 1f, 2f, AffixValueKind.Flat, weight: 0.8f, groupId: "armor_class"),
